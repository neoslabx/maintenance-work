...
class Maintenance_Work_Admin
{
	...
	*/
	...
	{
		$html = '<div class="wpbnd-header-plugin"><span class="header-icon"><i class="fas fa-sliders-h"></i></span> <span class="header-text">'.__('Maintenance Work', 'maintenance-work').'</span></div>';
		return $html;
	}
